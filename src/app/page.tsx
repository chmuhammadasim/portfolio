            ...
            <div className="max-w-2xl mx-auto mb-10 bg-[#0d1117] border border-gray-700/50 rounded-xl overflow-hidden shadow-2xl neon-glow-green">
              ...
              <div className="p-5 text-left font-mono text-sm sm:text-base space-y-1.5">
                ...
                <p className="text-gray-400 ml-4 leading-relaxed">
                  {user?.bio || "Building secure, scalable digital infrastructure. Passionate about cybersecurity, AI, and low-level systems."}
                </p>
                <p className="mt-3">
                  <span className="text-[#00ff41]">$</span>{" "}
                  <span className="animate-blink text-[#00ff41]">█</span>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-8 py-3.5 bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-xl font-mono font-semibold text-white hover:shadow-[0_0_30px_rgba(0,255,65,0.3)] transition-all duration-300 border border-emerald-400/30"
            >
              $ ssh connect
            </a>
            <a
              href={user?.html_url || "https://github.com/chmuhammadasim"}
              className="px-8 py-3.5 border border-[#00d4ff]/40 rounded-xl font-mono font-semibold text-[#00d4ff] hover:bg-[#00d4ff]/10 hover:shadow-[0_0_30px_rgba(0,212,255,0.2)] transition-all duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
              $ git clone profile
